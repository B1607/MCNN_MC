...
parser.add_argument("-ms", "--max_seq", type=int, default=800, 
                    help="The setting of sequence length.")
parser.add_argument("-n_fil", "--num_filter", type=int, default=128, 
                    help="The number of filters in the convolutional layer.")
parser.add_argument("-n_hid", "--num_hidden", type=int, default=1000, 
                    help="The number of hidden units in the dense layer.")
parser.add_argument("-bs", "--batch_size", type=int, default=1024, 
                    help="The batch size for training the model.")
parser.add_argument("-ws", "--window_sizes", nargs="+", type=int, default=[2, 4, 6, 8, 10], 
